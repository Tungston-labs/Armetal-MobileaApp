      ...
      >
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
          <View style={styles.header}>
            <View style={styles.logoRow}>
              {employee?.company_logo?.endsWith(".svg") ? (
                <SvgUri uri={employee.company_logo} width={70} height={40} />
              ) : (
                <Image source={{ uri: employee?.company_logo }} style={styles.logo} />
              )}
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate("ProfileScreen")}
            >
              <Image source={{ uri: getProfileUri(employee?.profile_pic) }} style={styles.profilePic} />
            </TouchableOpacity>
          </View>
          ...
          <Pressable style={styles.attendanceBox} onPress={() => navigation.navigate("AttendanceScreen")}>
            <View style={styles.headerRow}>
              <Text style={styles.attendanceTitle}>
                {today.toLocaleDateString("en-US", {
                  weekday: "long",
