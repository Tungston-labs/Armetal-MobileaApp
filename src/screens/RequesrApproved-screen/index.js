...
//   const route = useRoute(); // ✅ fix: declare route here
...
//       {/* ✅ Bottom Navbar with fixed route prop */}
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.card}>
          ...
          <View style={styles.section}>
            <Text style={styles.label}>Reason</Text>
            <Text style={styles.value}>
              Lorem ipsum dolor sit amet consectetur. Vitae scelerisque dui
              aliquet quis mattis vivamus scelerisque ligula. Risus lacus
              facilisis lectus egestas feugiat tellus nisi. Laoreet ipsum et non
              nunc semper. Imperdiet facilisis quis fringilla in arcu duis
              volutpat tincidunt.
            </Text>
          </View>
        </View>
