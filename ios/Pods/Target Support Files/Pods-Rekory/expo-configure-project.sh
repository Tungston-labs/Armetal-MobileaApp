...
with_node \
  ...
  --target "/Users/tungstonlabs/Desktop/Armetal-MobileaApp/ios/Pods/Target Support Files/Pods-Rekory/ExpoModulesProvider.swift" \
  --entitlement "/Users/tungstonlabs/Desktop/Armetal-MobileaApp/ios/Rekory/Rekory.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-background-fetch" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-device" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-location" "expo-notifications" "expo-sharing" "expo-splash-screen" "expo-system-ui" "expo-web-browser"
